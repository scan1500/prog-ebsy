...
#define PLL1_SETUP            1
#define PLL1CFG_Val           0x00000009
#define CCLKSEL_Val           0x00000103
#define USBCLKSEL_Val         0x00000100
#define EMCCLKSEL_Val         0x00000001
#define PCLKSEL_Val           0x00000004
#define PCONP_Val             0x07e88fbe // 0x00008840
